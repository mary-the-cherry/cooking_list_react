...
export default function NewEntry(props) {
        ...
        <div className="new-entry ">
            <form onSubmit={handleSubmit}>
                ...
                <div className="form-group row">
                    <label htmlFor="dish-name" className="col-sm-3 col-form-label col-form-label-lg">Dish</label>
                ...
                <div className="ingridient-form">
                    <div className="form-group row">
                        <label htmlFor="ingridient-name" className="col-sm-3 col-form-label col-form-label-lg" id="list-heading-ingridients">Ingridient</label>
    ...
    return <div className="entry-part">{ editNewDish? newEntryTemplate : newEntryButton }</div>
